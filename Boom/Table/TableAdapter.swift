...
public class TableAdapter<M: BoomModel, C: BoomCell>: TableAdapterProtocol,TableAdaterProtocolFunctions {
...
public extension TableAdapter {
	...
	public struct Context<M,C> {
		...
		internal init(model: BoomModel, cell: BoomCell?, path: IndexPath, table: UITableView) {

...
public class TableManager: NSObject, UITableViewDelegate, UITableViewDataSource, UITableViewDataSourcePrefetching {
	...
	/// Events of the table
	public var on = TableManager.Events()
	...
	/// Initialize a new manager for given table.
	///
	...
	public func reloadData(after task: ((TableManager) -> (TableReloadAnimations?))? = nil, onEnd: (() -> (Void))? = nil) {
		...
		var oldItemsInSections: [String: [BoomModel]] = [:]
	...
	@discardableResult
	public func add(models: [BoomModel]) -> TableSection {
	...
	internal func context(forItemAt index: IndexPath) -> (BoomModel, TableAdaterProtocolFunctions) {
	...
	/// - Returns: adapter.
	internal func context(forModel model: BoomModel) -> TableAdaterProtocolFunctions {
...
// MARK: - TableManager UITableViewDataSource/UITableViewDelegate
...
// MARK: - TableManager Cell/ReusableView Registration Support

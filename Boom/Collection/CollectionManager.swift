...
UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDataSourcePrefetching {
	...
	public var on = CollectionManager.Events()
	...
	/// - Returns: model
	public func item(at indexPath: IndexPath, safe: Bool = true) -> BoomModel? {
	...
	/// Register an adapter.
	/// An adapter is an object which manage a pair of `BoomModel`, `BoomCell` types which defines
	...
	@discardableResult
	public func add(models: [BoomModel]) -> CollectionSection {
